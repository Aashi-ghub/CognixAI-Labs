...
const FROM_EMAIL = "onboarding@resend.dev" // Default Resend domain - works for testing. Update to your verified domain in production
const NOTIFICATION_EMAIL = "gaurav.singh345@gmail.com" // Email address to receive form submission notifications
          ...
          <body style="font-family: Arial, sans-serif; line-height: 1.6; color: #333; max-width: 600px; margin: 0 auto; padding: 20px;">
            ...
            <div style="background: #f9fafb; padding: 30px; border-radius: 0 0 10px 10px; border: 1px solid #e5e7eb;">
              ...
              <div style="margin-top: 30px; padding-top: 20px; border-top: 2px solid #e5e7eb;">
                ...
                <a href="http://localhost:3000/admin/submissions" style="display: inline-block; background: #6b7280; color: white; padding: 12px 24px; text-decoration: none; border-radius: 6px; font-weight: bold;">View in Dashboard</a>
              </div>
            </div>
